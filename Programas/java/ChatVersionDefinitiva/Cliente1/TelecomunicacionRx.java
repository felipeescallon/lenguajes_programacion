...
int Mostrar=0;
	...
	while(HiloRx==HiloRxActual)						//Ciclo infinito y permanente
	{
		...
		int i = Flujoentrante.readInt();				//Leemos la variable que indica la funcion que debe realizar el sistema del cliente
			...
			if(i!=-2 && i!=-3 && i!=-4 && i!=-5 && i!=-7)				//SINO ES NINGUNO DE LOS CASOS ANTERIORES SIGNIFICA QUE OTRO USUARIO LE HA ESCRITO UN MENSAJE Y 
		...
		{
		System.out.println("Definitivamente un error");
