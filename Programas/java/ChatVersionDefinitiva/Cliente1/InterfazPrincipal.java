...
public class InterfazPrincipal 							//INTERFAZ PRINCIPAL
{
...
public InterfazPrincipal(Registro Definitiva, String CampoLogin1)
{
...
MarcoPrincipal = new Frame("Interfaz principal");				//Instanciamos el marco
