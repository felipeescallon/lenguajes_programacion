...
public class RestriccionChat 					 				//RESTRICCION
{
...
public RestriccionChat(Frame MarcoMaestro, String Oracion)						
{
...
EtiquetaRestriccion = new Label(Oracion);						//Intanciamos la etiqueta
...
DialogRestriccion.addWindowListener(						        //Cerrar la ventana del cuadro de dialogo
		new WindowAdapter()
		{
