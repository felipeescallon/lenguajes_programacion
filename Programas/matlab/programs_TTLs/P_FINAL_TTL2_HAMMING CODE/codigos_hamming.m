...
for z=1:1:columnas     
    ...
    %switch z
    %case 1, p1 = dec2bin((J(z)),n)
    %case 2, p2 = dec2bin((J(z)),n)    
    %case 3, p3 = dec2bin((J(z)),n)
    %  case 4, p4 = dec2bin((J(z)),n)
    %        case 5, p5 = dec2bin((J(z)),n)
    %            case 6, p3 = dec2bin((J(z)),n)
    %                case 7, p3 = dec2bin((J(z)),n)
    %                     case 8, p3 = dec2bin((J(z)),n)
    %                        case 9, p3 = dec2bin((J(z)),n)
    %                            case 10, p3 = dec2bin((J(z)),n)
    %                               case 11, p3 = dec2bin((J(z)),n)
    %                                    case 12, p3 = dec2bin((J(z)),n)
    %                                 
    %otherwise
    %break; 
    %-------NOOOOOOOOO es------------
