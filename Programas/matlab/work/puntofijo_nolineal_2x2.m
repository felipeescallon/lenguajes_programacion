...
f(1)= input('digite la ecuacion 1 con la variable x1 despejada: x1=f1(x1,x2). x1=')    %ecuación 1
f(2)= input('digite la ecuacion 2 con la variable x2 despejada: x2=f2(x1,x2). x2=')    %ecuación 2
