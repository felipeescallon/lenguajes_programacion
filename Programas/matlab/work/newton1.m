...
syms x1 x2 %x3
x0=input('digite los valores iniciales de x1 (x1_0), x2 (x2_0) en un vector fila. x0=')    %ecuación x0
...
f(1)= input('digite la ecuacion 1 con la variable x1  x1=f1(x1,x2). x1=')    %ecuación 1
f(2)= input('digite la ecuacion 2 con la variable x2  x2=f2(x1,x2). x2=')    %ecuación 2
%f(3)= input('digite la ecuacion 3 con la variable x2 despejada: x3=f3(x1,x2,x3). x3=')    %ecuación 3

ecu=[f(1);f(2)];
disp(ecu);

j=jacobian ([f(1);f(2)], [x1,x2]);%calcula la jacobiana de las funciones
jinver=inv (j); %calcula la inversa de la jacobiana
